...
export default function Projects() {
    return (<div id='projects'>
        ...
        <div className='projectItem' onClick={() => { window.open(ibmProject); }}>
        ...
        <div className='projectItem' onClick={() => { window.open(iotProject); }}>
        ...
        <div className='projectItem' onClick={() => { window.open(dissertation); }}>
        ...
        <div className='projectItem' onClick={() => { window.open(mitigating); }}>
        ...
        <div className='projectItem' onClick={() => { window.open(adnet); }}>
        ...
        <div className='projectItem' onClick={() => { window.open(dsCoursework); }}>
